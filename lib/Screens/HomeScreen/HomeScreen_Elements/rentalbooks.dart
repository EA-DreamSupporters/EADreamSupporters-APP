...
class RentalScrl extends StatefulWidget {
  const RentalScrl({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _RentalScrlState createState() => _RentalScrlState();
}

class _RentalScrlState extends State<RentalScrl> {
  final List<Book> _books = [
    Book(title: "Book 1", image: "assets/RBook1.jpg", price: 19.99),
    Book(title: "Book 2", image: "assets/RBook2.jpg", price: 24.99),
    Book(title: "Book 3", image: "assets/RBook3.jpg", price: 14.99),
  ];
